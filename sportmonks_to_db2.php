...
if ($last_xml_update_unix != $last_db_update['unix_time']) {
    ...
    foreach ($sportmonks['data'] as $sport) {
        ...
        $sport_id = '1';
        echo "questo è sport_id:";echo $sport['id'];//DEBUG
        ...
        foreach ($sport['league'] as $event['data']) {
           ...
           /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                if (! is_match_exists($match_id)) {
                    ...
                    echo "math_inserted_id:<br> ";echo $match_inserted_id;echo"<br>";
                    //Inserire qui 
                ...
                foreach ($sport['odds'] as $bets['id']) {
                    ...
                    foreach ( $bets['id'] as $bet) {
                        ...
                        if (! is_bet_exists($bet_id)) {
                            ...
                            $insert_bet = mysqli_query($link, 'INSERT INTO bets (match_id, betclic_id, name) VALUES (' . $match_id . ', ' . $bet_id . ', "' . $bet_name . '")');
